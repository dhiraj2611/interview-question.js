...
const Ganesh = {
 ...
 // document.getElementById("demo").innerHTML = Ganesh.fullName.call(Ganesh1); 
  ...
  document.getElementById("demo").innerHTML = anmol.fullName.apply(person1, ["Oslo", "Norway"]); 
  ...
  let fullName = Damy.fullName.bind(member);
...
//Question 4
  ...
  function myFunction(first,last,age,nationality){
   ...
   const Show = new myFunction('Dhiraj','singh',23,'indian');
   console.log(Show);
   ...
   const myFather = new Name('Ajay','singh',45,'Male');
   const myMother = new Name('Mira','singh',41,'Female');
